...
export const Button = ({id, type, border, clickedColor, color, selected } : iconsButton) => {
    ...
    return (
        <div id={id}>
            <ButtonStyles type="button" border={ border } clickedColor={clickedColor} color={color} id={id} state={changeColor}>
