...
export const ButtonHeaderCardStyles = styled.button(({color, size}: buttonheaderstyles) => css`
    display: flex;
    align-items: center;
...
export const BoxIconCardStyles = styled.div(({margin, padding}: boxicons) => css`
    padding: ${padding};
    margin: ${margin};
`);
