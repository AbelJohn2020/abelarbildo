...
const Tasks = ({ loading, error, tasks }: TaskType) => {
  ...
  return (
    <div>
      ...
      <div>
        <TaskModelTitle
          firstColumn="task name"
          secondColumn="task tag"
          thirdColumn="estimate"
          fourthColumn="task assign name"
          fifthColumn="due date"
        />
      </div>
      {loading ? (
        <Loading />
        ...
        <div>
          ...
          <div>
            <TaskModelName
              ...
              title="in progress"
              icon="down"
              length={inProgress && inProgress.length}
            />
          ...
          <div>
            <TaskModelName
              ...
              title="cancelled"
              icon="down"
              length={cancelled && cancelled.length}
            />
            <div>
              {cancelled &&
                cancelled.map(
